...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2f058593          	addi	a1,a1,752 # 1350 <malloc+0x110>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0f0080e7          	jalr	240(ra) # 115a <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2be50513          	addi	a0,a0,702 # 1358 <malloc+0x118>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	39270713          	addi	a4,a4,914 # 1458 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      e6:	27e50513          	addi	a0,a0,638 # 1360 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	26458593          	addi	a1,a1,612 # 1368 <malloc+0x128>
     10c:	4509                	li	a0,2
     10e:	00001097          	auipc	ra,0x1
     112:	04c080e7          	jalr	76(ra) # 115a <fprintf>
  exit(0);
     116:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     154:	22858593          	addi	a1,a1,552 # 1378 <malloc+0x138>
     158:	4509                	li	a0,2
     15a:	00001097          	auipc	ra,0x1
     15e:	000080e7          	jalr	ra # 115a <fprintf>
      exit(1);
     162:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1ea:	1a250513          	addi	a0,a0,418 # 1388 <malloc+0x148>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28c:	fb8080e7          	jalr	-72(ra) # 1240 <malloc>
     290:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d6:	f6e080e7          	jalr	-146(ra) # 1240 <malloc>
     2da:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     330:	f14080e7          	jalr	-236(ra) # 1240 <malloc>
     334:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     336:	4661                	li	a2,24
     338:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     376:	ece080e7          	jalr	-306(ra) # 1240 <malloc>
     37a:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37c:	4661                	li	a2,24
     37e:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b8:	e8c080e7          	jalr	-372(ra) # 1240 <malloc>
     3bc:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3be:	4641                	li	a2,16
     3c0:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dfca8a93          	addi	s5,s5,-516 # 13b0 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	dca50513          	addi	a0,a0,-566 # 1390 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	d1a60613          	addi	a2,a2,-742 # 13b8 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	cfeb0b13          	addi	s6,s6,-770 # 13d8 <malloc+0x198>
  ...
  return ret;
     ...
     70c:	cb850513          	addi	a0,a0,-840 # 13c0 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c5e50513          	addi	a0,a0,-930 # 13c8 <malloc+0x188>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c3060613          	addi	a2,a2,-976 # 13e0 <malloc+0x1a0>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	bc8a0a13          	addi	s4,s4,-1080 # 13e8 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	b9a60613          	addi	a2,a2,-1126 # 13f0 <malloc+0x1b0>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	afc60613          	addi	a2,a2,-1284 # 13b8 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	b1c60613          	addi	a2,a2,-1252 # 1408 <malloc+0x1c8>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     932:	aca50513          	addi	a0,a0,-1334 # 13f8 <malloc+0x1b8>
     936:	fffff097          	auipc	ra,0xfffff
     93a:	720080e7          	jalr	1824(ra) # 56 <panic>
    panic("syntax - missing )");
     93e:	00001517          	auipc	a0,0x1
     942:	ad250513          	addi	a0,a0,-1326 # 1410 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	b0670713          	addi	a4,a4,-1274 # 1470 <malloc+0x230>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	93260613          	addi	a2,a2,-1742 # 1348 <malloc+0x108>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	9dc58593          	addi	a1,a1,-1572 # 1428 <malloc+0x1e8>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	704080e7          	jalr	1796(ra) # 115a <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	96250513          	addi	a0,a0,-1694 # 13c0 <malloc+0x180>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	9ba48493          	addi	s1,s1,-1606 # 1438 <malloc+0x1f8>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	90c58593          	addi	a1,a1,-1780 # 1440 <malloc+0x200>
     b3c:	4509                	li	a0,2
     b3e:	00000097          	auipc	ra,0x0
     b42:	61c080e7          	jalr	1564(ra) # 115a <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ed6:	f3e080e7          	jalr	-194(ra) # e10 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     ef0:	0805cb63          	bltz	a1,f86 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  while(--i >= 0)
     f44:	02e05c63          	blez	a4,f7c <printint+0x9a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     f90:	e486                	sd	ra,72(sp)
     f92:	e0a2                	sd	s0,64(sp)
     f94:	f84a                	sd	s2,48(sp)
     f96:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f9c:	1a090a63          	beqz	s2,1150 <vprintf+0x1c2>
     fa0:	fc26                	sd	s1,56(sp)
     fa2:	f44e                	sd	s3,40(sp)
     fa4:	f052                	sd	s4,32(sp)
     fa6:	ec56                	sd	s5,24(sp)
     fa8:	e85a                	sd	s6,16(sp)
     faa:	e45e                	sd	s7,8(sp)
     fac:	8aaa                	mv	s5,a0
     fae:	8bb2                	mv	s7,a2
  ...
  state = 0;
     ...
     fba:	4b55                	li	s6,21
     fbc:	a839                	j	fda <vprintf+0x4c>
        putc(fd, c);
     fbe:	85ca                	mv	a1,s2
     fc0:	8556                	mv	a0,s5
     fc2:	00000097          	auipc	ra,0x0
     fc6:	efe080e7          	jalr	-258(ra) # ec0 <putc>
     fca:	a019                	j	fd0 <vprintf+0x42>
    } else if(state == '%'){
     fcc:	01498d63          	beq	s3,s4,fe6 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
     fd0:	0485                	addi	s1,s1,1
     fd2:	fff4c903          	lbu	s2,-1(s1)
     fd6:	16090763          	beqz	s2,1144 <vprintf+0x1b6>
    if(state == 0){
     fda:	fe0999e3          	bnez	s3,fcc <vprintf+0x3e>
      if(c == '%'){
     fde:	ff4910e3          	bne	s2,s4,fbe <vprintf+0x30>
        state = '%';
     fe2:	89d2                	mv	s3,s4
     fe4:	b7f5                	j	fd0 <vprintf+0x42>
      if(c == 'd'){
     fe6:	13490463          	beq	s2,s4,110e <vprintf+0x180>
     fea:	f9d9079b          	addiw	a5,s2,-99
     fee:	0ff7f793          	zext.b	a5,a5
     ff2:	12fb6763          	bltu	s6,a5,1120 <vprintf+0x192>
     ff6:	f9d9079b          	addiw	a5,s2,-99
     ffa:	0ff7f713          	zext.b	a4,a5
     ffe:	12eb6163          	bltu	s6,a4,1120 <vprintf+0x192>
    1002:	00271793          	slli	a5,a4,0x2
    1006:	00000717          	auipc	a4,0x0
    100a:	48270713          	addi	a4,a4,1154 # 1488 <malloc+0x248>
    ...
    1028:	ebe080e7          	jalr	-322(ra) # ee2 <printint>
    102c:	8bca                	mv	s7,s2
      } else {
    ...
    1044:	ea2080e7          	jalr	-350(ra) # ee2 <printint>
    1048:	8bca                	mv	s7,s2
      state = 0;
    104a:	4981                	li	s3,0
    104c:	b751                	j	fd0 <vprintf+0x42>
    ...
    1060:	e86080e7          	jalr	-378(ra) # ee2 <printint>
    1064:	8bca                	mv	s7,s2
      state = 0;
    1066:	4981                	li	s3,0
    1068:	b7a5                	j	fd0 <vprintf+0x42>
    106a:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    106c:	008b8c13          	addi	s8,s7,8
    1070:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    1074:	03000593          	li	a1,48
    1078:	8556                	mv	a0,s5
    107a:	00000097          	auipc	ra,0x0
    107e:	e46080e7          	jalr	-442(ra) # ec0 <putc>
  putc(fd, 'x');
    1082:	07800593          	li	a1,120
    1086:	8556                	mv	a0,s5
    1088:	00000097          	auipc	ra,0x0
    108c:	e38080e7          	jalr	-456(ra) # ec0 <putc>
    1090:	4941                	li	s2,16
    ...
    10aa:	e1a080e7          	jalr	-486(ra) # ec0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10ae:	0992                	slli	s3,s3,0x4
    10b0:	397d                	addiw	s2,s2,-1
    10b2:	fe0914e3          	bnez	s2,109a <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    10b6:	8be2                	mv	s7,s8
      state = 0;
    10b8:	4981                	li	s3,0
    10ba:	6c02                	ld	s8,0(sp)
    10bc:	bf11                	j	fd0 <vprintf+0x42>
        s = va_arg(ap, char*);
    10be:	008b8993          	addi	s3,s7,8
    10c2:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    10c6:	02090163          	beqz	s2,10e8 <vprintf+0x15a>
        while(*s != 0){
    10ca:	00094583          	lbu	a1,0(s2)
    10ce:	c9a5                	beqz	a1,113e <vprintf+0x1b0>
          putc(fd, *s);
    10d0:	8556                	mv	a0,s5
    10d2:	00000097          	auipc	ra,0x0
    10d6:	dee080e7          	jalr	-530(ra) # ec0 <putc>
          s++;
    10da:	0905                	addi	s2,s2,1
        while(*s != 0){
    10dc:	00094583          	lbu	a1,0(s2)
    10e0:	f9e5                	bnez	a1,10d0 <vprintf+0x142>
        s = va_arg(ap, char*);
    10e2:	8bce                	mv	s7,s3
      state = 0;
    10e4:	4981                	li	s3,0
    10e6:	b5ed                	j	fd0 <vprintf+0x42>
          s = "(null)";
    10e8:	00000917          	auipc	s2,0x0
    10ec:	36890913          	addi	s2,s2,872 # 1450 <malloc+0x210>
        while(*s != 0){
    10f0:	02800593          	li	a1,40
    10f4:	bff1                	j	10d0 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    10f6:	008b8913          	addi	s2,s7,8
    10fa:	000bc583          	lbu	a1,0(s7)
    10fe:	8556                	mv	a0,s5
    1100:	00000097          	auipc	ra,0x0
    1104:	dc0080e7          	jalr	-576(ra) # ec0 <putc>
    1108:	8bca                	mv	s7,s2
      state = 0;
    110a:	4981                	li	s3,0
    110c:	b5d1                	j	fd0 <vprintf+0x42>
        putc(fd, c);
    110e:	02500593          	li	a1,37
    1112:	8556                	mv	a0,s5
    1114:	00000097          	auipc	ra,0x0
    1118:	dac080e7          	jalr	-596(ra) # ec0 <putc>
      state = 0;
    111c:	4981                	li	s3,0
    111e:	bd4d                	j	fd0 <vprintf+0x42>
        putc(fd, '%');
    1120:	02500593          	li	a1,37
    1124:	8556                	mv	a0,s5
    1126:	00000097          	auipc	ra,0x0
    112a:	d9a080e7          	jalr	-614(ra) # ec0 <putc>
        putc(fd, c);
    112e:	85ca                	mv	a1,s2
    1130:	8556                	mv	a0,s5
    1132:	00000097          	auipc	ra,0x0
    1136:	d8e080e7          	jalr	-626(ra) # ec0 <putc>
      state = 0;
    113a:	4981                	li	s3,0
    113c:	bd51                	j	fd0 <vprintf+0x42>
        s = va_arg(ap, char*);
    113e:	8bce                	mv	s7,s3
      state = 0;
    1140:	4981                	li	s3,0
    1142:	b579                	j	fd0 <vprintf+0x42>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    117c:	e16080e7          	jalr	-490(ra) # f8e <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    11b2:	de0080e7          	jalr	-544(ra) # f8e <vprintf>
}
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    126a:	08977e63          	bgeu	a4,s1,1306 <malloc+0xc6>
  ...
  if(p == (char*)-1)
    ...
    12bc:	a08d                	j	131e <malloc+0xde>
  hp->s.size = nu;
    12be:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12c2:	0541                	addi	a0,a0,16
    12c4:	00000097          	auipc	ra,0x0
    12c8:	efa080e7          	jalr	-262(ra) # 11be <free>
  return freep;
    12cc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12d0:	c13d                	beqz	a0,1336 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12d2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12d4:	4798                	lw	a4,8(a5)
    12d6:	02977463          	bgeu	a4,s1,12fe <malloc+0xbe>
    if(p == freep)
    12da:	00093703          	ld	a4,0(s2)
    12de:	853e                	mv	a0,a5
    12e0:	fef719e3          	bne	a4,a5,12d2 <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    12e4:	8552                	mv	a0,s4
    12e6:	00000097          	auipc	ra,0x0
    12ea:	b92080e7          	jalr	-1134(ra) # e78 <sbrk>
  if(p == (char*)-1)
    12ee:	fd5518e3          	bne	a0,s5,12be <malloc+0x7e>
        return 0;
    12f2:	4501                	li	a0,0
    ...
    12fc:	a03d                	j	132a <malloc+0xea>
    12fe:	7902                	ld	s2,32(sp)
    1300:	6a42                	ld	s4,16(sp)
    1302:	6aa2                	ld	s5,8(sp)
    1304:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1306:	fae489e3          	beq	s1,a4,12b8 <malloc+0x78>
        p->s.size -= nunits;
    130a:	4137073b          	subw	a4,a4,s3
    130e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1310:	02071693          	slli	a3,a4,0x20
    1314:	01c6d713          	srli	a4,a3,0x1c
    1318:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    131a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    131e:	00001717          	auipc	a4,0x1
    1322:	cea73923          	sd	a0,-782(a4) # 2010 <freep>
      return (void*)(p + 1);
    1326:	01078513          	addi	a0,a5,16
  }
}
