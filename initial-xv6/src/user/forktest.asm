...
forktest(void)
{
  ...
  3e:	43650513          	addi	a0,a0,1078 # 470 <printlog+0xc>
  ...
  68:	45c50513          	addi	a0,a0,1116 # 4c0 <printlog+0x5c>
  ...
  8a:	3fa50513          	addi	a0,a0,1018 # 480 <printlog+0x1c>
  ...
  a4:	3f850513          	addi	a0,a0,1016 # 498 <printlog+0x34>
  ...
  e4:	3d050513          	addi	a0,a0,976 # 4b0 <printlog+0x4c>
